    ...
    <div className="flex bg-[url('')] bg-gradient-to-r from-[#0D1A1C] to-[#1B2C2E] text-white">
      ...
      <div className="flex flex-col  px-6 mx-30 my-8 w-full max-w-sm">
        ...
        <div className="space-y-4">
          ...
          {/* Sign In Button */}
          <button className="w-full py-2 rounded-xl bg-[#A4FEB7] text-black font-semibold text-base cursor-pointer">
            Sign in
          </button>
          ...
          {/* Google Sign In */}
          <button className="w-full py-2 flex items-center justify-center border border-gray-500 rounded-xl text-white hover:bg-gray-800 cursor-pointer text-sm">
